...
electronTable = simpleCandidateFlatTableProducer.clone(
    ...
    variables = cms.PSet(CandVars,
        ...
        LepGood_pfRelIso03_chg = Var("userFloat('PFIsoChg')/pt",float),
        LepGood_pfRelIso03_all = Var("userFloat('PFIsoAll')/pt",float),
        LepGood_lostHits = Var("gsfTrack.hitPattern.numberOfLostHits('MISSING_INNER_HITS')", "uint8"),
        ...
        LepGood_mvaWinter22V1noIso = Var("userFloat('mvaNoIso')", float),
    ),
