...
outpath = "/afs/cern.ch/work/c/cvicovil/private/Oviedo/Trigger/Plots/AfterEditingPlugin/"
...
outFile = ROOT.TFile("GroupingComparison_StdToBayes_Nov10_after.root","RECREATE")
outFile.cd()
...
with open('GroupingComparison_StdToBayes_Nov10_after.pickle', 'rb') as handle:
