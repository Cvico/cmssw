  ...
  if (algo_ == Standard)
    ...
    for (const auto& muonpath : outmpaths) {
      correlatedMetaPrimitives.emplace_back(muonpath->rawId(),
		...
		//			    (muonpath->primitive(4) == 0) ? -1 : muonpath->primitive(4)->channelId(), 
		//			    (muonpath->primitive(4) == 0) ? -1 : muonpath->primitive(4)->tdcTimeStamp(), 
		//			    (muonpath->primitive(4) == 0) ? NONE : muonpath->primitive(4)->laterality(), 
		//			    (muonpath->primitive(5) == 0) ? -1 : muonpath->primitive(5)->channelId(), 
		//			    (muonpath->primitive(5) == 0) ? -1 : muonpath->primitive(5)->tdcTimeStamp(), 
		//			    (muonpath->primitive(5) == 0) ? NONE : muonpath->primitive(5)->laterality(), 
		//			    (muonpath->primitive(6) == 0) ? -1 : muonpath->primitive(6)->channelId(), 
		//			    (muonpath->primitive(6) == 0) ? -1 : muonpath->primitive(6)->tdcTimeStamp(), 
		//			    (muonpath->primitive(6) == 0) ? NONE : muonpath->primitive(6)->laterality(), 
		//			    (muonpath->primitive(7) == 0) ? -1 : muonpath->primitive(7)->channelId(), 
		//			    (muonpath->primitive(7) == 0) ? -1 : muonpath->primitive(7)->tdcTimeStamp(), 
		//			    (muonpath->primitive(7) == 0) ? NONE : muonpath->primitive(7)->laterality());
    }
  }
